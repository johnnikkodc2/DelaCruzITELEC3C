                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <img src="{{ asset('img/' . $category->category_image) }}" alt=""></td>
                                            <td>
                                            ...
                                            <td> <a href="{{url('/all/category/delete/'.$category->id)}}">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <img src="{{ asset('img/' . $deletedCategory->category_image) }}" alt=""></td>
                                            <td>
                                            ...
                                            <td> <a href="{{url('/all/category/forceDelete/'.$deletedCategory->id)}}">
